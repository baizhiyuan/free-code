...
# free-code installer
# Usage: curl -fsSL https://raw.githubusercontent.com/baizhiyuan/free-code/main/install.sh | bash
...
REPO="https://github.com/baizhiyuan/free-code.git"
...
echo ""
printf "  ${BOLD}Or use OpenAI direct:${RESET}\n"
printf "    ${CYAN}export CLAUDE_CODE_USE_OPENAI=1${RESET}\n"
printf "    ${CYAN}export OPENAI_API_KEY=\"sk-...\"${RESET}\n"
printf "    ${CYAN}export OPENAI_BASE_URL=\"http://localhost:9090\"${RESET}\n"
echo ""
printf "  ${BOLD}Anthropic browser login (optional):${RESET}\n"
